...
console.log(intersection2([1, 3, 5, 7], [3, 6, 7, 9]));
...
//function that checks if string contains "X"
...
console.log(containsX("Xray"));
//---------------------------------------

function containsX2(string) {
    return Array.from(string).some(char => char === "X");
    //Array.form(string) => converts the string into an array of character
}

console.log(containsX2("Xray"));
